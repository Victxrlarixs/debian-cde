...
The system implements ARIA (Accessible Rich Internet Applications) attributes for screen reader compatibility.

### ARIA Live Regions

A global announcement region provides non-intrusive feedback:
...
- **Polite**: Non-urgent announcements (window opened, file saved)
- **Assertive**: Important announcements (errors, warnings)
...
The system announces the following events:
